...
import { Menu, X, Phone, Stethoscope, Heart, Sparkles, ArrowRight } from 'lucide-react';
            ...
            <div className="container mx-auto px-6 py-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center space-x-6">
                        ...
                        <button 
                            ...
                            className="group relative bg-gradient-to-r from-purple-500 via-purple-600 to-indigo-600 text-white px-5 py-2.5 rounded-xl font-semibold hover:from-purple-600 hover:to-indigo-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-purple-500/30 flex items-center space-x-2 border border-white/20 overflow-hidden"
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                            <Sparkles className="w-4 h-4 group-hover:rotate-12 transition-transform duration-300" />
                            <span className="text-sm relative z-10">Get Started</span>
                ...
                <div className={`lg:hidden overflow-hidden transition-all duration-500 ${
                    ...
                    <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-4 shadow-xl border border-emerald-100">
                        ...
                        <button 
                            onClick={handleGetStarted}
                            className="w-full bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-4 py-3 rounded-xl font-semibold mt-3 flex items-center justify-center space-x-2 hover:from-purple-600 hover:to-indigo-700 transition-all duration-300 shadow-lg relative overflow-hidden group"
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12 transform -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                            <Sparkles className="w-4 h-4 group-hover:rotate-12 transition-transform duration-300" />
