...
import { Heart, Award, Users, Sparkles, ArrowDown, Stethoscope, Shield, Clock, Star, Activity, Zap } from 'lucide-react';
...
const AboutHero = () => {
    ...
    const floatingIcons = [
        ...
        { icon: Clock, delay: '1s', duration: '9s', size: 'w-8 h-8', position: 'bottom-40 right-10' },
        { icon: Activity, delay: '3s', duration: '11s', size: 'w-10 h-10', position: 'bottom-60 left-16' },
        { icon: Star, delay: '5s', duration: '7s', size: 'w-12 h-12', position: 'top-1/3 right-1/4' },
            ...
            <div className="relative z-10 container mx-auto px-6 pt-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <h1 className={`text-5xl lg:text-7xl font-black text-white leading-tight mb-8 transform transition-all duration-1000 ${
                        ...
                        <span className="block">Caring for Kenya's</span>
                    ...
                    <p className={`text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 transform transition-all duration-1000 ${
                        ...
                        With over 15 years of dedicated service, we've built a legacy of trust,
                        compassion, and excellence in veterinary care across Kenya.
                    </p>
                    ...
                    <div className={`grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12 transform transition-all duration-1000 ${
                        ...
                        {[
                            ...
                            { icon: Users, number: '12K+', label: 'Happy Families' },
                            { icon: Heart, number: '98%', label: 'Success Stories' }
                        ].map((stat, index) => (
