...
import { Stethoscope, Heart, Shield, Activity, ArrowDown, Sparkles, Award, Scissors, Pill, Microscope, Thermometer, Syringe } from 'lucide-react';
...
const ServicesHero = () => {
    ...
    // Floating icon circles data for services
    const floatingIcons = [
        { icon: Stethoscope, delay: '0s', duration: '8s', size: 'w-12 h-12', position: 'top-20 left-10' },
        { icon: Heart, delay: '2s', duration: '10s', size: 'w-10 h-10', position: 'top-40 right-20' },
        { icon: Shield, delay: '4s', duration: '12s', size: 'w-14 h-14', position: 'top-60 left-1/4' },
        { icon: Scissors, delay: '1s', duration: '9s', size: 'w-8 h-8', position: 'bottom-40 right-10' },
        { icon: Activity, delay: '3s', duration: '11s', size: 'w-10 h-10', position: 'bottom-60 left-16' },
        { icon: Pill, delay: '5s', duration: '7s', size: 'w-12 h-12', position: 'top-1/3 right-1/4' },
        { icon: Microscope, delay: '6s', duration: '13s', size: 'w-9 h-9', position: 'bottom-1/3 right-1/3' },
        { icon: Thermometer, delay: '2.5s', duration: '10s', size: 'w-11 h-11', position: 'top-1/2 left-8' },
        { icon: Syringe, delay: '4.5s', duration: '9s', size: 'w-10 h-10', position: 'bottom-20 left-1/3' }
    ];
            ...
            <div className="relative z-10 container mx-auto px-6 pt-20">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className={`inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 text-white/90 border border-white/20 hover:bg-white/20 transition-all duration-300 cursor-pointer group mb-8 transform ${
                        ...
                        <span className="text-base font-semibold">Professional Veterinary Services</span>
                    ...
                    <p className={`text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 transform transition-all duration-1000 ${
                        ...
                        From routine check-ups to emergency surgeries, we provide complete veterinary
                        care with state-of-the-art equipment and compassionate expertise.
                    </p>
                    ...
                    <div className={`grid grid-cols-3 gap-8 max-w-2xl mx-auto mb-12 transform transition-all duration-1000 ${
                        ...
                        {[
                            { icon: Stethoscope, number: '20+', label: 'Service Types' },
